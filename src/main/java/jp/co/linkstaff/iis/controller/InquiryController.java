...
//	}
	...
	/**
	 * 0 Argument empty Constructor.
	 * As SpringBoot framework suggested.
	 * NOTE: Please find the best place to place this constructor. 
	 */
	...
	//#9 OK
	/**
	 * Return a list that matches the  'name' ignoring case
	 * @param name
	 * @return List<Inquiry>
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/name/{name}", produces = { "application/hal+json" })
	public List<Inquiry> getInquiriesByName(@PathVariable String name){
		List<Inquiry> inquiries = null;
		inquiries = inquiryService.getInquiriesByName(name);
	...
	//#11 OK
	/**
	 * Return a list that matches the  'email' ignoring case
	 * @param name
	 * @return List<Inquiry>
	 */	
	@RequestMapping(method = RequestMethod.GET, value = "/email/{email}", produces = { "application/hal+json" })
	public List<Inquiry> getInquiriesByEmail(@PathVariable String email){
		List<Inquiry> inquiries = null;
		inquiries = inquiryService.getInquiriesByEmail(email);
	...
	//#12 OK
	/**
	 * Return a list that matches the  'Telephone'  ignoring case
	 * @param name
	 * @return List<Inquiry>
	 */
	@RequestMapping(value="/tel/{tel}", method=RequestMethod.GET, produces = { "application/hal+json" })
	public List<Inquiry> getInquiriesByTel(@PathVariable String tel){
		List<Inquiry> inquiries = null;
		inquiries = inquiryService.getInquiriesByTel(tel);
	...
	//#14 OK
	/**
	 * GET Method: Returns List<Inquiry> that matches 'nameKana' ignoring case
	 * @param nameKana
	 * @return List<Inquiry>
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/nameKana/{nameKana}", produces = { "application/hal+json" })
	public List<Inquiry> getInquiriesByNameKana(@PathVariable String nameKana){
		List<Inquiry> inquiries = null;
		inquiries = (List<Inquiry>) inquiryService.getInquiriesByNameKana(nameKana);
